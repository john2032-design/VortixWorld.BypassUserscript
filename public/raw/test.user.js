...
// @version      3.2
// @description  Bypass 💩 Fr (Merged with Auto Luarmor & Neumorphism UI)
// @author       afk.l0l
// @match        *://*/*
...
;(function () {
  ...
  const SHARED_UI_CSS = `
    ...
    .vw-header-bar {
      ...
      background: var(--vw-bg) !important;
      box-shadow: 0 4px 10px #141414 !important;
    ...
    .vw-spinner {
      ...
      border-top: 4px solid var(--vw-text) !important;
      border-radius: 50% !important;
  ...
  const API_UI_CSS = `
    ...
    .vw-api-loading-ring {
      ...
      animation: vw-api-spin 0.8s linear infinite !important;
    }
  ...
  const TOAST_CONTAINER_CSS = `
    ...
    .vw-toast-progress {
      ...
      box-shadow: inset 1px 1px 2px #0a0a0a;
    }
  ...
  function showHashExpireUI(finalUrl) {
    ...
    // FIX: Ensure body and HTML visibility isn't trapped by previous overrides
    ...
    // Append to documentElement so parent div logic won't hide it
