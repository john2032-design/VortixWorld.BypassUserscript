;(function () {
  ...
  const keys = {
    ...
    userAgentOption: 'vw_user_agent_option'
  }
  ...
  const SETTINGS_CSS = `
    ...
    * {
    ...
    .vw-select {
      ...
      box-shadow: inset 3px 3px 6px #0a0a0a, inset -3px -3px 6px #1e1e1e !important;
  ...
  function createSettingsUI() {
        ...
        <div class="vw-body">
          ...
          <div class="vw-row vw-row-select">
            <div class="vw-label">
              ...
              <div class="vw-label-desc">Select UA for bypass requests</div>
            </div>
            <div class="vw-select-wrapper">
              <select id="vwUaSelect" class="vw-select">
                <option value="default">Device Default</option>
                <optgroup label="Desktop">
                  <option value="win10_chrome">Windows 10 Chrome</option>
                  <option value="mac_safari">Mac Safari</option>
                </optgroup>
                <optgroup label="Android">
                  <option value="android_chrome">Android 10 Chrome</option>
                  <option value="android_samsung">Samsung Internet</option>
                </optgroup>
                <optgroup label="iOS">
    ...
    function loadSettings() {
      ...
      const savedUa = getStoredValue(keys.userAgentOption, 'default')
      if (uaSelect) uaSelect.value = savedUa
    }
    ...
    function saveSettings() {
      ...
      if (uaSelect) setStoredValue(keys.userAgentOption, uaSelect.value)
