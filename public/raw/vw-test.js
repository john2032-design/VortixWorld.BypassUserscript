;(function () {
  ...
  const SETTINGS_CSS = `
    ...
    * {
    ...
    .vw-log-level-vw { color: #60a5fa !important; }
  ...
  function createSettingsUI() {
      ...
      <div class="vw-panel vw-hidden" id="vwConsolePanel" role="dialog" aria-modal="true" aria-label="VW Console">
        ...
        <div class="vw-body">
          <div class="vw-tabs">
            ...
            <button class="vw-tab" data-level="vw">VW</button>
          </div>
    ...
    function getFilteredLogs() {
      ...
      if (currentFilter === 'vw') {
        return logs.filter(log => log.level === 'vw')
      }
    ...
    function renderConsoleLogs() {
      ...
      consoleContainer.innerHTML = logs
        .map((log) => {
          ...
          let levelClass = `vw-log-level-${log.level || 'info'}`
          if (log.level === 'vw') levelClass = 'vw-log-level-vw'
          else if (log.level === 'websocket') levelClass = 'vw-log-level-websocket'
