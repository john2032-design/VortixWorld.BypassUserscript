async function runLocalTpiLiBypass() {
  ...
  try {
    ...
    if (typeof addConsoleLine === 'function') addConsoleLine(`> Alias: ${alias}`);
    ...
    if (typeof addConsoleLine === 'function') addConsoleLine('> Page fetched, extracting token...');
    ...
    if (typeof addConsoleLine === 'function') addConsoleLine('> Token extracted, decoding...');
    ...
    if (typeof addConsoleLine === 'function') addConsoleLine('> URL decoded successfully');
